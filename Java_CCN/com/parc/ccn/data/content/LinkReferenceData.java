 ...
 *
 */
public class LinkReferenceData extends GenericXMLEncodable implements XMLEncodable {
	...
	public LinkReferenceData(ContentName targetName, LinkAuthenticator targetAuthenticator) {
		_targetName = targetName;
		_targetAuthenticator = targetAuthenticator;
	}
	
	public LinkReferenceData(ContentName targetName) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		final LinkReferenceData other = (LinkReferenceData) obj;
