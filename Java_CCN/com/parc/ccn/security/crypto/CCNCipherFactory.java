...
public class CCNCipherFactory {
	...
	/**
	 * Make an output stream to write segment data out to CCN. CipherOutputStream
	 * is a FilterOutputStream, this will wrap the output stream given.
	 ...
	 */
	public static CipherOutputStream newSegmentEncryptionStream(String encAlgorithm, 
		...
		return new CipherOutputStream(innerStream, cipher);
	}
