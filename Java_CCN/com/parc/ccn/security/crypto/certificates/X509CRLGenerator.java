...
public class X509CRLGenerator {
	 ...
	 */
	public X509CRLGenerator(String issuerName, Date thisUpdate, Date nextUpdate) {
		this(new X509Name(issuerName), thisUpdate, nextUpdate);
	}

	public X509CRLGenerator(X509Name issuerName, Date thisUpdate, Date nextUpdate) {
	 ...
	 **/
	public X509CRLGenerator(String issuerName, long duration) {
		this(new X509Name(issuerName), duration);
	}
	
	public X509CRLGenerator(X509Name issuerName, long duration) {
