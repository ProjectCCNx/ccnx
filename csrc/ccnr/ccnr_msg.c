...
const char *ccnr_usage_message =
    ...
    "    CCNR_START_WRITE_SCOPE_LIMIT=-1\n"
    "      -1..2 (default -1) If >= 0, process start-write(-checked) interests with a scope\n"
    "      not exceeding the given value.  -1 is unlimited, 0 is effectively read-only.\n"
