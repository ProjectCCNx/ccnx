...
main(int argc, char **argv)
{
    ...
    int res;
    if (argv[1] == NULL) {
        fprintf(stderr, "%s: Reads stuff written by ccnsendchunks under "
    ...
    incoming->data = calloc(1, sizeof(struct mydata));
    
    /* XXX - should use a template to tailor the interest more carefully. */
