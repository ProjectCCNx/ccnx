...
public class InterestTest {
	...
	public void testMatchDigest() throws MalformedContentNameStringException {
		...
		ContentObject co = ContentObject.buildContentObject(name, 
				null, content, 
