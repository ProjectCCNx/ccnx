...
/*
 * A KeyLocator specifies where a content consumer or intermediary can find the public ke
 * necessary to verify a piece of content. It might include the key itself, a certificat
...
public class KeyLocator extends GenericXMLEncodable implements XMLEncodable, Serializable {
    ...
    /*
     * Make a KeyLocator containing only a nam
     * @param name the nam
     */
    ...
    /*
     * Make a KeyLocator containing a key name and the desired publishe
     * @param name the key nam
     * @param publisher the desired publishe
     */
    ...
    /*
     * Make a KeyLocator specifying a KeyName -- a structure combining the nam
     * at which to find the key and authentication information by which to verify i
     * @param keyName the KeyName to use to retrieve and authenticate the ke
     *
   ...
   /*
    * Make a KeyLocator containing an explicit public ke
    * @param key the ke
    */
     ...
     * @param certificate the certificat
     */
    ...
    /*
 	 * Get the key if presen
     * @return the key or nul
     */
	public PublicKey key() { return _key; 

	/*
	 * Get the KeyName if presen
	 * @return the KeyName or nul
	 */
    public KeyName name() { return _keyName; 
   
    /*
     * Get the certificate if presen
     * @return the certificate or nul
     */
