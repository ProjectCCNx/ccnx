...
public class PublisherID extends GenericXMLEncodable implements XMLEncodable, Comparable<PublisherID>, Serializable {
    ...
    /*
     * Create a PublisherID specifying a public key as a signer or issue
     * @param key the ke
     * @param isIssuer false if it signed the content directly, true if it signed the key of the content signe
     */
    ...
    /*
     * Create a PublisherID specifying a public key in a certificate as a signer or issue
     * @param cert the certificat
     * @param isIssuer false if it signed the content directly, true if it signed the key of the content signe
     *
   ...
   /*
    * Create a PublisherID from a raw digest and a typ
    * @param publisherID the diges
    * @param publisherType the typ
    */
	...
	/*
	 * Create a signer PublisherID from an existing PublisherPublicKeyDiges
	 * @param keyID the key diges
	 */
	...
	/*
	 * Helper method to generate a public key diges
	 * @param key the key to diges
	 * @return the diges
	 *
	...
	/*
	 * Helper method to generate a certificate diges
	 * @param cert the certificate to diges
	 * @return the diges
	 * @throws CertificateEncodingExceptio
	 */
	...
	/*
	 * Helper method to generate a certificate diges
	 * @param digestAlg the digest algorithm to us
	 * @param cert the certificate to diges
	 * @return the diges
	 * @throws CertificateEncodingExceptio
