...
/*
 * A listener used to receive callbacks when data arrives matching one of ou
 ...
 * the listener can return a new Interest, which will be expressed on its behalf, usin
 * it as the callback listener when data is returned in response. This new Interest can b
 * the same as the previous Interest, derived from it, or completely unrelated. Since dat
